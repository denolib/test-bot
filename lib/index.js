...
function botLog() {
    ...
    console.log.apply(console, __spreadArrays([">> DENO TEST BOT:"], msg));
}
...
function cloneAndTest(repoPath, localPath, branchName) {
    return __awaiter(this, void 0, void 0, function () {
        var p0, output, GIT, _a, code, stdout, stderr, error, e_1, p;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    p0 = utils_1.deferred();
                    rimraf_1.default(localPath, function (_) { return p0.resolve(); });
                    return [4 /*yield*/, p0];
                case 1:
                    _b.sent();
                    botLog("Check if deno is installed...");
                    return [4 /*yield*/, util_1.promisify(fs_1.exists)(INSTALLED_DENO_PATH)];
                case 2:
                    if (!(_b.sent())) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, utils_1.system(process.cwd() + "/" + INSTALLED_DENO_PATH + " test -A", {
                            cwd: localPath,
                            env: { "NO_COLOR": 1 }
                        })];
                case 5:
                    _a = _b.sent(), code = _a.code, stdout = _a.stdout, stderr = _a.stderr, error = _a.error;
                    output = {
...
function handlePullRequest(context) {
    return __awaiter(this, void 0, void 0, function () {
        var head, sha, cloneUrl, branchName, prPreStatus, uniqueLocalPath, info, prStatus;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    prPreStatus = createPRStatus(sha, TestStatus.PENDING, "Test Pending");
                    // TODO: check failures
                    return [4 /*yield*/, context.github.repos.createStatus(context.repo(prPreStatus))];
                case 1:
                    // TODO: check failures
                    _a.sent();
